  ...
  return (
    <div className="w-full bg-white">
      <style>{`
        ...
        .progress-bar-animate.delay-3 {
          animation-delay: 0.6s;
        }
        
        .progress-bar-animate.delay-4 {
      ...
      <nav className="sticky top-0 z-50 border-b border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="font-semibold text-gray-900">Infinite Solutions</div>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4">Ontario math • grades 7–12</p>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">Start September stronger in math.</h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-6 leading-relaxed">Personalized math support to help your child catch up, start strong, or get ahead.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="/readiness" className="px-6 py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 text-center">Check their math readiness</a>
                <a href="#options" className="px-6 py-3 border-2 border-gray-300 text-gray-900 font-medium rounded hover:bg-gray-50 text-center">Explore tutoring options</a>
              </div>
            </div>
            
            {/* Skill Progress Visual */}
            <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
              <p className="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-6">Example skill breakdown</p>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <span className="font-medium text-gray-900">Overall Math</span>
                    <span className={`text-2xl font-bold ${getTextColorForPercentage(68)}`}>68%</span>
                  </div>
                  <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                    <div 
                      className={`h-full ${getColorForPercentage(68)} progress-bar-animate`}
                      style={{'--final-width': '68%'}}
                    ></div>
                  </div>
                </div>
                    ...
                    {[
                      ...
                      <div key={skill.label}>
                        ...
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            className={`h-full ${getColorForPercentage(skill.value)} progress-bar-animate delay-${idx + 1}`}
                            style={{'--final-width': `${skill.value}%`}}
                          ></div>
                        </div>
                      </div>
                    ))}
              ...
              <p className="text-xs text-gray-500 mt-6 pt-6 border-t border-gray-200">This is an illustrative example, not a real student result. A grade doesn't tell you which skills are causing the problem.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">What does your child need?</h2>
          
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <div className="border border-gray-200 rounded-lg p-8 flex flex-col">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Catch Up</h3>
              <p className="text-gray-700 mb-6 leading-relaxed font-medium">Identify and strengthen gaps from previous math courses.</p>
              <div className="text-sm text-gray-600 space-y-2 flex-grow">
                <p className="font-medium text-gray-700">Good for students who:</p>
                <ul className="space-y-1">
                  <li>• have inconsistent marks</li>
                  <li>• struggle independently</li>
                  <li>• have foundational gaps</li>
                  <li>• need review before moving forward</li>
                </ul>
              </div>
            </div>

            <div className="border border-gray-200 rounded-lg p-8 flex flex-col">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Start Strong</h3>
              <p className="text-gray-700 mb-6 leading-relaxed font-medium">Review key skills and begin the new school year prepared.</p>
              <div className="text-sm text-gray-600 space-y-2 flex-grow">
                <p className="font-medium text-gray-700">Good for students who:</p>
                <ul className="space-y-1">
                  <li>• want a back-to-school review</li>
                  <li>• are unsure whether they are ready</li>
                  <li>• want more confidence going in</li>
                  <li>• want to strengthen prerequisites</li>
                </ul>
              </div>
            </div>

            <div className="border border-gray-200 rounded-lg p-8 flex flex-col">
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Get Ahead</h3>
              <p className="text-gray-700 mb-6 leading-relaxed font-medium">Build confidence with upcoming concepts and prepare for what is next.</p>
              <div className="text-sm text-gray-600 space-y-2 flex-grow">
                <p className="font-medium text-gray-700">Good for students who:</p>
                <ul className="space-y-1">
                  <li>• are already doing well</li>
                  <li>• want enrichment</li>
                  <li>• want to preview upcoming material</li>
                  <li>• want to prepare for a harder course</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Don't wait for the first bad test to find out what's missing.</h2>
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">A grade doesn't tell you what your child actually needs help with.</h3>
          <p className="text-lg text-gray-600 mb-12 max-w-2xl leading-relaxed">Two students can receive the same overall grade while having completely different gaps. One might be strong in computation but weak in reasoning. Another might understand theory but struggle with application. A single number hides all of that.</p>
          
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              "They understand it when someone explains it, but struggle again independently.",
              "Their mark isn't terrible, but I don't know what they're actually missing.",
              "I don't want to discover in October that they're already behind."
            ].map((point, i) => (
              <div key={i} className="p-6 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-gray-900 font-medium leading-relaxed">{point}</p>
              </div>
            ))}
          </div>

          <p className="text-lg text-gray-900 font-medium mb-8">That's why we look beyond the grade and identify the individual skills behind it.</p>
          <a href="/readiness" className="inline-block px-6 py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700">Check their readiness</a>
        </div>
      </section>

      {/* Section 3: What September Math Ready Is */}
      <section id="how-it-works" className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-16">Know where to focus before school starts.</h2>
          
          <div className="grid md:grid-cols-5 gap-4 md:gap-2">
            {[
              {num: "01", title: "Assess", desc: "Review where the student currently stands."},
              {num: "02", title: "Identify", desc: "Find the most important skill gaps and prerequisite weaknesses."},
              {num: "03", title: "Teach", desc: "Target the concepts that need the most attention."},
              {num: "04", title: "Practice", desc: "Provide personalized practice based on what was identified."},
              {num: "05", title: "Plan", desc: "Give the student clear recommendations for September."}
            ].map((step, i) => (
              <div key={i} className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-2">{step.num}</div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">{step.title}</h3>
                <p className="text-sm text-gray-600 leading-relaxed">{step.desc}</p>
                {i < 4 && <div className="hidden md:block mt-4 text-2xl text-gray-300">→</div>}
              </div>
            ))}
          </div>
          
          <div className="mt-12 pt-12 border-t border-gray-200">
            <p className="text-gray-600">App-supported practice and progress tracking may also be used where appropriate.</p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 md:p-12 mb-12">
            <div className="space-y-4 text-center md:text-left">
              {[
                ...
                "Skill tracking",
                "Accountability",
                "Next session uses the results"
              ].map((item, i) => (
                <div key={i} className="flex items-center justify-center md:justify-start gap-4">
                  <span className="font-medium text-gray-900">{item}</span>
                  {i < 4 && <span className="text-2xl text-gray-400 hidden md:inline">↓</span>}
                  {i < 4 && <span className="text-2xl text-gray-400 md:hidden">↓</span>}
                </div>
              ))}
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {title: "See progress at the skill level—not just one overall grade.", label: "Skill Progress Dashboard"},
              {title: "Students know exactly what to work on between sessions.", label: "Personalized Practice"},
              {title: "Tutoring can respond to what is actually happening between sessions.", label: "Progress and Results Dashboard"}
            ].map((item, i) => (
              <div key={i} className="space-y-4">
                <div className="bg-gray-100 rounded-lg aspect-square flex items-center justify-center border-2 border-dashed border-gray-300">
                  <div className="text-center">
                    <p className="text-gray-500 font-medium">[App Screenshot {i + 1}]</p>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12">What families say.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-gray-50 border border-gray-200 rounded-lg p-8">
                ...
                <p className="text-gray-700 mb-6 italic">[Insert real parent testimonial]</p>
                <p className="font-medium text-gray-900">[Parent first name / student grade if permitted]</p>
              </div>
            ))}
          </div>
        </div>
